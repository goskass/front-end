...
class ChatConsumer(AsyncWebsocketConsumer):
    ...
    async def connect(self):
        ...
        group_send_dict = {"type": "chat_message", "message": 'Присоединился к комнате', "username": self.user.username,
    ...
    async def disconnect(self, close_code):
        ...
        await self.channel_layer.group_send(
            self.room_group_name, {"type": "chat_message", "message": 'Покинул комнату', "username": self.scope['user'].username,
                                   "usernames": usernames, 'whom': 'room'}
        )
